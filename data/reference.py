...
VOCAB = [
    ...
    ("vital_event", "birth",     "Nacimientos", 0, 3, None),
    ...
    ("dim_name", "mother_age_band",     None, 0, 11, None),
    ("dim_name", "father_age_band",     None, 0, 12, None),
    ("dim_name", "mother_nationality",  None, 0, 13, None),
    ("dim_name", "father_nationality",  None, 0, 14, None),
    ("dim_name", "marital_status",      None, 0, 20,
     "of the mother at the birth; the only union-status data loaded"),
    ("dim_name", "registration_timing", None, 0, 21,
     "dentro / fuera del plazo legal"),
...
NATIONALITIES = [
    ...
    ("China",                "CHN", "China",                0, 17),
    ("Rusia",                "RUS", "Rusia",                0, 18),
    ("Argentina",            "ARG", "Argentina",            0, 19),
    ("Ecuador",              "ECU", "Ecuador",              0, 20),
